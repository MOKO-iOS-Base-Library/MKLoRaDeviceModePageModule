...
@interface MKStandbyModeController ()<UITableViewDelegate,
...
@implementation MKStandbyModeController

- (void)dealloc {
    NSLog(@"MKStandbyModeController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKLoRaDeviceModePageModule", @"MKStandbyModeController", @"mk_loraDeviceMode_slotSaveIcon.png") forState:UIControlStateNormal];
